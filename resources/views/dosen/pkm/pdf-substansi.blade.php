...
<head>
    <meta charset="utf-8">
    <title>Substansi Proposal PKM — {{ $p->judul }}</title>
    <style>
...
<div class="header">
    ...
    <h2 style="margin-top:8px;">SUBSTANSI PROPOSAL PENGABDIAN KEPADA MASYARAKAT</h2>
    <h3>{{ $p->judul }}</h3>
...
@if ($p->permasalahan_solusi)
    <h4>B. Permasalahan & Solusi</h4>
    <p style="white-space: pre-wrap;">{{ $p->permasalahan_solusi }}</p>
@endif

@if ($p->metode)
    <h4>C. Metode Pelaksanaan</h4>
