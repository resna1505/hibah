...
@if ($p->rab->isNotEmpty())
    ...
    @foreach ($rabByKategori as $namaKategori => $items)
        ...
        <table class="bordered small">
            <thead>
                <tr>
                    <th>Item</th><th width="30%">Justifikasi</th>
                    <th width="10%" class="text-end">Qty</th><th width="8%">Satuan</th>
                    <th width="15%" class="text-end">Harga Satuan</th><th width="15%" class="text-end">Sub Total</th>
                </tr>
            </thead>
            <tbody>
                @foreach ($items as $r)
                ...
                @endforeach
                <tr><td colspan="5" class="text-end"><strong>SUB TOTAL</strong></td><td class="text-end"><strong>Rp {{ number_format($items->sum('sub_total'), 0, ',', '.') }}</strong></td></tr>
            </tbody>
        </table>
    @endforeach
    <table class="bordered">
