...
<head>
    <meta charset="utf-8">
    <title>@yield('title', 'Operator') | Hibah Internal UNIBA</title>
    ...
    <style>
        ...
        .hibah-sidebar .sidebar-link.ms-3 { padding-left:2.2rem; font-size:.85rem; }

        .topbar { position: sticky; top: 0; z-index: 100; }
        .page-content { padding: 1.5rem 1.75rem; }

        @media (max-width: 991px) {
            .hibah-sidebar-wrap { position: fixed; left: -260px; top: 0; transition: left .3s; z-index: 1050; }
            .hibah-sidebar-wrap.show { left: 0; }
        }
    </style>
...
<body>
    <div class="d-flex">
        <div class="hibah-sidebar-wrap d-none d-lg-block">
            @include('layouts._partials.sidebar-operator')
        </div>
